...
SELECT Person.Fornavn, Person.Etternavn, Rolle.Fornavn as RolleFornavn, Rolle.Etternavn as RolleEtternavn, Teaterstykke.Navn as TeaterstykkeNavn
FROM Teaterstykke
...
INNER JOIN Skuespiller on Skuespiller.Ansatt_ID = Skuespiller_i_rolle.Ansatt_ID
INNER JOIN Person on Skuespiller.Ansatt_ID = Person.Ansatt_ID
ORDER BY Teaterstykke.Navn ASC
